...
import 'juegos_espera_model.dart';
...
class _JuegosEsperaWidgetState extends State<JuegosEsperaWidget> {
  late JuegosEsperaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JuegosEsperaModel());
  }
              ...
              children: [
                Flexible(
                  child: Padding(
                    ...
                    child: Text(
                      '¿Dejaste algún juego por ahí, pero tienes pensado retomarlo?\nEste es el lugar perfecto para colocarlo.',
