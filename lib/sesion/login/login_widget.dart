...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    _model.correElectronicoController ??= TextEditingController();
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            12.0, 0.0, 20.0, 0.0),
                        child: TextFormField(
                          controller: _model.correElectronicoController,
                          obscureText: false,
                          ...
                          validator: _model.correElectronicoControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
